...
export function RippleSection({ themes = ['#FFFFFF', '#000000'], className, children, ...props }: RippleSectionProps) {
  ...
  return (
    <div ref={containerRef} className={`relative overflow-hidden ${className || ''}`} onClick={handleClick} {...props}>
      {/* Current Background */}
      <div className="absolute inset-0 z-0" style={{ backgroundColor: themes[currentIndex] }} />
      ...
      <div
        ...
        style={{
          ...
          transition: isRippling ? 'clip-path 1s cubic-bezier(0.4, 0, 0.2, 1)' : 'none',
        }}
