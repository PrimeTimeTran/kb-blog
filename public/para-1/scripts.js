// https://www.magnific.com/vectors/parallax-background-svg#uuid=2764411b-19f7-440f-b38b-d52dd10a48cc
// I've written to dos next. After reading it, I want u to review code, and contemplate whether or not we should
// go ahead and implement stack tracing/execution for troubleshooting more easily moving forward.

// - TODO:
// - Master Control:
//  - Restore colors(these dont match the color of the svg I downloaded)
//  - Sort layer ASC/DESC by name, z-index
//  - remove extension from the initial input. Currently has svg. Isn't necessary. Export as svg by default.
//  -
// - Layer z-index()
//   UI, State update, indicator,
//   UI, State update, indicator,
// - Grouping somehow... Not sure if it should be drag and drop(into nested column of control panel row[child of...]) or a toggle in the pane row. think illustrator.
