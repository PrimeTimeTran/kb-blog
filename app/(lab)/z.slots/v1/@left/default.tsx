  ...
  return (
    <div className="p-4 border rounded-lg bg-surface flex flex-col gap-3 w-full">
      ...
      <div className="flex gap-2 items-center">
        <button className="px-3 py-1 bg-blue-500 text-on-surface rounded" onClick={() => setCount((c) => c + 1)}>
          +
        </button>

        <button className="px-3 py-1 bg-red-500 text-on-surface rounded" onClick={() => setCount((c) => c - 1)}>
          -
        </button>
...
export default function Page() {
  ...
  return (
    <div className="flex flex-col bg-surface-variant h-full p-2">
      ...
      <div>
        <h1 className="text-xl font-bold text-sky-500">We can maintain state across page renders</h1>
...
export const FILE_PATH = 'app/(lab)/slots/v1/@left/default.tsx';
