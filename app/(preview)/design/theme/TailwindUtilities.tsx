          ...
          <main className="min-w-0 flex-1 space-y-12">
            ...
            >
              <div className="space-y-8">
                ...
                <p className="leading-8 text-on-surface-variant">
                  In Omni, text colors should remain semantic. Avoid directly using raw palette
                  colors like <code>text-gray-500</code> in application UI.
                </p>
