...
export function Material() {
  return (
    <main className="max-w-7xl mx-auto p-6 lg:p-12">
      <code>python gogogo</code>
      <pre>python gogogo</pre>
...
export const DESIGN_SYSTEM_TABS = [
  { id: 1, label: 'Material', icon: '🧱', content: <Material /> },
  { id: 2, label: 'DesignToken', icon: '🪙', content: <DesignToken /> },
  { id: 3, label: 'Tailwind Text Utilities', icon: '🔡', content: <TailwindUtilities /> },
  {
    id: 4,
    label: 'Material Token Palette Explained',
    icon: '🌈',
    content: <MaterialTokenPalette />,
  },
  {
    id: 5,
    label: 'Material Palette Reference',
    icon: '※',
    content: <MaterialColorPalette />,
  },
  ...OMNI_TABS,
