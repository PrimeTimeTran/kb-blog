...
This is a series about how the web actually _works as a system_—and how that system shapes what we can publish, build, and communicate.
...
- interfaces _are_ content systems
...
It is _shared understanding through different entry points into the same system._
...
// layout1.jsx
<SystemShell>
  <Shell left={<h1>left</h1>}>{children}</Shell>
</SystemShell>
```
...
// page1.jsx
<div>
  <Shell right={<h1>left</h1>}>{children}</Shell>
</div>
```
