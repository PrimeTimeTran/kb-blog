...
export function Orchestrator() {
  ...
  if (!boot.ready || !boot.snapshot || !boot.framework) {
  ...
  // Check if VFS is good.
  const isFileSystemBooted = '';
  if (isFileSystemBooted) {
    return (
  ...
  return <EditorPage snapshot={boot.snapshot} boot={boot} />;
}
